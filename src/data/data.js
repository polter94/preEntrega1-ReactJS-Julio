const productos = [
    {
        ...
        desc: "Soap, Price y Ghost vuelven en una versión completamente remasterizada de la campaña de 2009 de Call of Duty aclamada por la crítica.  Vuelve a vivir la increíble campaña individual del éxito de 2009 Call of Duty: Modern Warfare 2, completamente remasterizada para una nueva generación. Justo después de los dramáticos acontecimientos de Call of Duty 4: Modern Warfare, Modern Warfare 2 te sumerge en una apasionante aventura de acción en la que deberás enfrentarte a una nueva amenaza mortal decidida a llevar el mundo al borde del colapso. La campaña individual se remasterizó por completo con texturas y animaciones mejoradas, procesamiento basado en la física, iluminación HDR y mucho más. Redescubre las misiones clásicas como Máximo Riesgo, El Gulag o Whiskey Hotel cuando unas otra vez a Soap, Price, Ghost y el resto de la Task Force 141 en una batalla por restaurar el orden mundial." ,
        price: "$12000" ,
        category: "shooter" ,
        stock: "" ,
    ...
    
    {
        ...
        desc: 'Nobody leaves here alive! THE HOUSE OF THE DEAD: Remake is a remade version of the game introduced in 1997 in arcade platform. A classic arcade rail-shooter receives a whole new entourage and gameplay changes to suit modern gaming standards. • Well known arcade classic with modern graphics and controls - True to the original gameplay - Local 2-player multiplayer - Multiple endings - Photomode - Achievements - Armory with unlockable weapons - Hordes of the undead monstrosities in a new game mode- Gallery with encountered enemies and bosses' ,
        price: "$3000" ,
        category: "shooter" ,
        stock: "" ,
